...
.admLRT <- function(full, reduced) {
  ...
  # A J-DEPENDENT OBJECTIVE CANNOT BE COMPARED ACROSS J. Where a study was
  # generated by banding a source (`stratify`), the likelihood depends on the
  # stratum count -- measured at 441 units across J = 1 to 500 with the model
  # correct -- so two fits built at different `strata_nodes` are on different
  # scales and their difference means nothing.
